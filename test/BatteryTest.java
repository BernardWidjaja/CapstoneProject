...
// Simple dummy LogManager to prevent null pointer errors during tests (not used when setup is removed)
/*class DummyLogManager extends LogManager {
    public DummyLogManager() {
        super("battery_test_logs");
    }
}
*/
