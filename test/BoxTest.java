...
public class BoxTest {
    ...
    void testBoxInit() {
        ...
        System.out.println("testBoxInit Passed");
    }
    ...
    void testSetPositionCoor() {
        ...
        System.out.println("testSetPositionCoor Passed");
    }

    @Test
    void testSetPositionNoThrow() {
        assertDoesNotThrow(() -> box.setPosition(9, 9));
        System.out.println("testSetPositionNoThrow Passed");
    }
    ...
    void testToStringContainsInfo() {
        ...
        System.out.println("testToStringContainsInfo Passed");
    }
    ...
    void testDisplayInfoRunsWithoutError() {
        ...
        System.out.println("testDisplayInfoRunsWithoutError Passed");
    }
}
